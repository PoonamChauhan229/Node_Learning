...
const upload=multer({
    //providing here all the configurations
    dest:'images'// shortname for destination
})
// We will provide here the route for uploading the images.
//we need access the middleware from the multer library
//in between the path and function, we will pass the middleware 
//single takes 1 string parameter
app.post('/upload',upload.single('upload'),async(req,res)=>{
    res.send()
    //Let us upload and check varoius files
})
